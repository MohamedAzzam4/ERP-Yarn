/**
 * Quality parameters management page.
 * Route: /management/master-data/quality-parameters
 * WP-02-01: Admin screen for quality-parameters master data. WP-01-08 approved UI.
  ...
  return (
    ...
    >
      <MasterDataListPage
        ...
        descriptionAr="إدارة معايير واختبارات الجودة"
        addLabelAr="إضافة معيار جودة"
        emptyTitleAr="لا يوجد معايير جودة نشطة"
        emptyDescriptionAr="استخدم زر «إضافة معيار جودة» لإنشاء أول معيار."
      />
    </ManagementShell>
  );
}
