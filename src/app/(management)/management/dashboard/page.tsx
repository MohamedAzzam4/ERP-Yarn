/**
 * Owner Dashboard Reference Screen page.
 *
 * Route: /management/dashboard
 * Fixture: reference-fixtures-v1
 *
 * WP-01-07: This is a reference screen with fixture data only.
 * No real database writes, no API calls.
 */
import { redirect } from "next/navigation";
import { getErpAuthContextWithRoles } from "@/server/auth/erp-context";
import { getManagementNavForRole, isManagementShellRole } from "@/components/shells/nav-config";
import { ManagementShell } from "@/components/shells/management-shell";
import { OwnerDashboardReference } from "@/components/reference-screens/owner-dashboard-reference";
...
export default async function DashboardPage() {
  ...
  return (
    <ManagementShell
      ...
      breadcrumbs={[{ label: "الرئيسية", href: "/management" }, { label: "لوحة التحكم" }]}
    >
      <OwnerDashboardReference />
    </ManagementShell>
  );
}
