...
## Discovered Count: 46 paths

The canonical search now discovers 46 paths:
...
- Category A (executable destructive test/QA harness): 44
...
A + B + C + D = 44 + 0 + 0 + 2 = 46 = discovered count ✓
